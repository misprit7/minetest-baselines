...
class TwoActionTwoRewardThirtyTwoSteps(gym.Env):
    metadata = {'render_modes': ['human', 'rgb_array']}
...
class OneActionOneRewardThirtyTwoSteps(gym.Env):
    metadata = {"render_modes": ["human", "rgb_array"]}
    def __init__(self, **kwargs):
        self.observation_shape = (128, 128, 1)
        self.observation_space = spaces.Box(low = np.zeros(self.observation_shape), 
    ...
    def _get_obs(self):
        self.curr_observation = np.ones(self.observation_shape, dtype = np.float32)
        return self.curr_observation
...
class TwoActionTwoObservationTwoRewardThirtyTwoSteps(gym.Env):
    metadata = {"render_modes": ["human", "rgb_array"]}
    def __init__(self, **kwargs):
        self.observation_shape = (128, 128, 1)
        self.observation_space = spaces.Box(low = np.zeros(self.observation_shape), 
